            ...
            <section class="articulo-contenido-texto mt-50">
                ...
                <div id="datos-cm" class="seccion-bloque">
                    ...
                    <div class="alerta-importante mt-30 p-25 bg-amarillo-opaco border-radius-15 flex-start gap-20">
                        ...
                        <p class="m-0 fs-09"><span class="subrayado-amarillo">Confirmá el horario antes de ir:</span> los horarios de atención pueden actualizarse y suelen depender del turno asignado. Chequealo en la SRT o <a href="https://wa.me/5491124786144" target="_blank" rel="noopener" style="color:inherit;">escribinos</a> antes de sacar el turno.</p>
                    </div>
