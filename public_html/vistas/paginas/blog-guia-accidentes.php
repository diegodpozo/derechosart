        ...
        <article class="articulo-cuerpo">
            ...
            <section class="articulo-contenido-texto mt-50">
                ...
                <div id="que-es-accidente" class="seccion-bloque mb-60">
                    <a href="#que-es-guia" class="link-volver-indice"><?= render_icon('arrow-up') ?> Volver al índice</a>
                ...
                <div id="accidente-itinere" class="seccion-bloque mb-60">
                    ...
                    <!-- CASO REAL (EMBED) -->
                    <div class="mt-40">
                        <h4 class="mb-20"><?= render_icon('play', 'mr-10') ?> <span class="subrayado-amarillo">CASO REAL</span> — Marcos cobró 15 millones</h4>
