    ...
    <div class="contenedor grid-blog">
        ...
        <article class="articulo-cuerpo">
            ...
            <section class="articulo-contenido-texto mt-50">
                ...
                <!-- SECCION 1 -->
                <div id="que-es-accidente" class="seccion-bloque mb-180">
                    ...
                    <h4 class="mt-40 mb-0"><?= render_icon('calendar-day-solid', 'icono-chico mr-10') ?> Ejemplos frecuentes:</h4>
                    <div class="recuadro-ejemplos bg-gris p-15 border-radius-20">
                        <div class="grid-iconos-blog">
                            <div class="item-ejemplo">
                                <img src="<?= BASE_URL ?>publico/font-awesome-svgs/solid/caida.png" alt="Caida">
                                <span>Te caíste de una escalera o andamio</span>
                            </div>
                            <div class="item-ejemplo">
                                <img src="<?= BASE_URL ?>publico/font-awesome-svgs/solid/caja.png" alt="Carga">
                                <span>Te lastimaste cargando o moviendo peso</span>
                            </div>
                            <div class="item-ejemplo">
                                <img src="<?= BASE_URL ?>publico/font-awesome-svgs/solid/martillo.png" alt="Herramienta">
                                <span>Te golpeaste con una máquina o herramienta</span>
                            </div>
                            <div class="item-ejemplo">
                                <img src="<?= BASE_URL ?>publico/font-awesome-svgs/solid/fuego.png" alt="Quemadura">
                                <span>Sufriste una quemadura en el trabajo</span>
                            </div>
                            <div class="item-ejemplo">
                                <img src="<?= BASE_URL ?>publico/font-awesome-svgs/solid/rayo.png" alt="Electricidad">
                                <span>Tuviste una descarga eléctrica</span>
                            </div>
                            <div class="item-ejemplo">
                                <img src="<?= BASE_URL ?>publico/font-awesome-svgs/solid/tabla.png" alt="Tarea">
                    ...
                    <div class="alerta-importante mt-30 p-25 bg-amarillo-opaco border-radius-15 flex-start gap-20">
                        <div class="alerta-icon"><?= render_icon('circle-exclamation', 'icono-grande txt-amarillo') ?></div>
                ...
                <!-- SECCION 2 -->
                <div id="accidente-itinere" class="seccion-bloque mb-180">
                    ...
                    <h4 class="mt-40 mb-0"><?= render_icon('calendar-day-solid', 'icono-chico mr-10') ?> Algunos ejemplos:</h4>
                    <div class="recuadro-ejemplos bg-gris p-15 border-radius-20">
                        <ul class="lista-items-blog">
                            <li><?= render_icon('car', 'icono-chico mr-10') ?> Un choque de auto o moto camino al trabajo</li>
                            <li><?= render_icon('person-walking', 'icono-chico mr-10') ?> Una caída en la calle en el trayecto habitual</li>
                            <li><?= render_icon('bicycle', 'icono-chico mr-10') ?> Un accidente en bicicleta volviendo a tu casa</li>
                            <li><?= render_icon('bus', 'icono-chico mr-10') ?> Una lesión en el transporte público en tu recorrido de siempre</li>
                                </ul>
                            </div>
                            <!-- CASO REAL (EMBED) -->
                    <div class="mt-40">
                ...
                <!-- SECCION 3 -->
                <div id="como-denunciar" class="seccion-bloque mb-180">
                    ...
                    <div class="pasos-denuncia mt-30">
                        <h4 class="mb-20"><?= render_icon('phone', 'icono-chico mr-10') ?> Cómo podés denunciar:</h4>
                        <ul class="lista-items-blog">
                            <li><?= render_icon('mobile-screen-button', 'icono-chico mr-10') ?> <strong>Por teléfono:</strong> llamando a la ART de tu empresa</li>
                            <li><?= render_icon('laptop-solid-full', 'icono-chico mr-10') ?> <strong>Por mail:</strong> con alguna constancia de envío</li>
                            <li><?= render_icon('envelope', 'icono-chico mr-10') ?> <strong>Por telegrama gratuito:</strong> desde cualquier sucursal del Correo Argentino</li>
                        </ul>
                    </div>
                ...
                <!-- SECCION 4 -->
                <div id="cobertura-art" class="seccion-bloque mb-180">
                    ...
                    <div class="grid-iconos-blog mt-30">
                        ...
                        <div class="item-ejemplo">
                            <img src="<?= BASE_URL ?>publico/font-awesome-svgs/solid/Copilot_20260603_174028.png" alt="Estudios Médicos" class="icono-grande">
                    ...
                    <div class="tip-blog mt-30 p-20 bg-gris border-radius-15 flex-start gap-20">
                        <?= render_icon('camera', 'icono-grande txt-amarillo') ?>
                ...
                <!-- SECCION 5 -->
                <div id="alta-con-dolor" class="seccion-bloque mb-180">
                ...
                <!-- SECCION 6 -->
                <div id="como-funciona-indemnizacion" class="seccion-bloque mb-180">
                    ...
                    <div class="tabla-plazos mt-30">
                        <h4 class="mb-20"><?= render_icon('chart-simple', 'icono-chico mr-10') ?> Qué se tiene en cuenta para calcularla:</h4>
                        <div class="custom-table-blog">
                            <div class="tr-blog header">
                                <div>Factor</div>
                    ...
                    <div class="tip-blog mt-30 p-20 bg-gris border-radius-15 flex-start gap-20">
                        <?= render_icon('circle-question', 'icono-grande txt-amarillo') ?>
                ...
                <!-- SECCION 7 -->
                <div id="art-rechaza" class="seccion-bloque mb-180">
                    ...
                    <p><?= render_icon('face-frown-open', 'icono-chico mr-10') ?> Un rechazo genera mucha angustia. Pero la realidad es que no significa que perdiste. Las ART rechazan accidentes por distintos motivos, y muchas veces se puede revertir esa decisión.</p>
                    
                    <div class="recuadro-ejemplos mt-30 bg-gris p-15 border-radius-20">
                        <h4 class="mb-20"><?= render_icon('location-dot', 'icono-chico mr-10') ?> Por qué suelen rechazar:</h4>
                        <ul class="lista-items-blog">
                            <li><?= render_icon('clock-solid', 'icono-chico mr-10') ?> Dicen que el accidente no pasó durante la jornada laboral</li>
                            <li><?= render_icon('road', 'icono-chico mr-10') ?> Discuten el recorrido en un accidente in itinere</li>
                            <li><?= render_icon('file-circle-xmark', 'icono-chico mr-10') ?> Alegan que no hay suficientes pruebas</li>
                            <li><?= render_icon('link-slash', 'icono-chico mr-10') ?> Cuestionan la relación entre lo que te pasó y tu trabajo</li>
                        </ul>
                    </div>
                ...
                <!-- SECCION 8 -->
                <div id="errores-comunes" class="seccion-bloque mb-180">
                    ...
                    <ul class="lista-items-blog blog-errores mt-30">
                        <li><?= render_icon('circle-xmark-solid-full', 'txt-rojo mr-10') ?> No denunciar el accidente o esperar demasiado tiempo</li>
                        <li><?= render_icon('circle-xmark-solid-full', 'txt-rojo mr-10') ?> Seguir trabajando lastimado sin avisar nada</li>
                        <li><?= render_icon('circle-xmark-solid-full', 'txt-rojo mr-10') ?> No guardar estudios, recetas ni certificados médicos</li>
                        <li><?= render_icon('circle-xmark-solid-full', 'txt-rojo mr-10') ?> Firmar papeles de la ART sin que nadie te los explique antes</li>
                        <li><?= render_icon('circle-xmark-solid-full', 'txt-rojo mr-10') ?> Aceptar sin cuestionar el porcentaje de incapacidad que fijó la ART</li>
                        <li><?= render_icon('circle-xmark-solid-full', 'txt-rojo mr-10') ?> Creer que el alta médica o el primer rechazo son el final del reclamo</li>
                    </ul>
                    <a href="#que-es-guia" class="link-volver-indice mt-30"><?= render_icon('arrow-up') ?> Volver al índice</a>
                </div>

                <!-- SECCION 9 -->
                <div id="documentacion" class="seccion-bloque mb-180">
                    
                    <h2 class="titulo-seccion-blog"><a href="#preg-9"><span class="num-sec">9</span> Qué documentación guardar desde el primer día</a></h2>
                    <p><?= render_icon('folder-open', 'icono-chico mr-10') ?> Parece un detalle menor, pero puede ser lo más importante de todo. Juntá todo en una carpeta física o digital desde el minuto uno.</p>
                    
                    <ul class="lista-items-blog blog-doc mt-30">
                        <li><?= render_icon('file-lines', 'icono-chico mr-10') ?> Estudios: radiografías, resonancias, tomografías</li>
                        <li><?= render_icon('file-lines', 'icono-chico mr-10') ?> Recetas y certificados médicos</li>
                        <li><?= render_icon('file-lines', 'icono-chico mr-10') ?> Informes de kinesiología y rehabilitación</li>
                        <li><?= render_icon('file-lines', 'icono-chico mr-10') ?> Constancias de atención en los centros de la ART</li>
                        <li><?= render_icon('file-lines', 'icono-chico mr-10') ?> Mails o mensajes que intercambiaste con la ART</li>
                        <li><?= render_icon('file-lines', 'icono-chico mr-10') ?> Telegramas enviados o recibidos</li>
                        <li><?= render_icon('camera', 'icono-chico mr-10') ?> Fotos de las lesiones si las tenés</li>
                        <li><?= render_icon('file-lines', 'icono-chico mr-10') ?> Copia de la denuncia del accidente</li>
                    </ul>

                    <div class="tip-blog mt-40 p-20 bg-gris border-radius-15 flex-start gap-20">
                        <?= render_icon('lightbulb', 'icono-grande txt-amarillo') ?>
                ...
                <!-- SECCION 10 -->
                <div id="preguntas-frecuentes" class="seccion-bloque mb-180">
                ...
                <div class="cierre-articulo py-40 border-top mt-50">
                    <div class="flex-start gap-20 mb-30">
                        <?= render_icon('whatsapp', 'icono-grande txt-verde') ?>
                        <div>
                    ...
                    <div class="articulo-footer-meta mt-50 flex-between fs-08 txt-gris-medio">
                        ...
                        <span class="italic"><?= render_icon('scale-balanced', 'mr-5') ?> DerechosART · Estudio Jurídico Laboral · derechosart.com.ar · Guía 2026</span>
                    </div>
                </div>
