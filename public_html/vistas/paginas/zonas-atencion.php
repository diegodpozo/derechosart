                        ...
                        <div class="lista-seo-links">
                            ...
                            <details>
                                ...
                                <div class="flex-column gap-5 mt-5 pl-10">
                                    ...
                                    <a href="<?= BASE_URL ?>abogados-art-san-nicolas">San Nicolás</a>
                                    <a href="<?= BASE_URL ?>abogados-art-san-telmo">San Telmo</a>
                                    <a href="<?= BASE_URL ?>abogados-art-velez-sarsfield">Vélez Sársfield</a>
                                    <a href="<?= BASE_URL ?>abogados-art-versalles">Versalles</a>
                                    <a href="<?= BASE_URL ?>abogados-art-villa-crespo">Villa Crespo</a>
                                    <a href="<?= BASE_URL ?>abogados-art-villa-del-parque">Villa del Parque</a>
                                    <a href="<?= BASE_URL ?>abogados-art-villa-devoto">Villa Devoto</a>
                                    <a href="<?= BASE_URL ?>abogados-art-villa-general-mitre">Villa General Mitre</a>
                                    <a href="<?= BASE_URL ?>abogados-art-villa-lugano">Villa Lugano</a>
                                    <a href="<?= BASE_URL ?>abogados-art-villa-luro">Villa Luro</a>
                                    <a href="<?= BASE_URL ?>abogados-art-villa-ortuzar">Villa Ortúzar</a>
                                    <a href="<?= BASE_URL ?>abogados-art-villa-pueyrredon">Villa Pueyrredón</a>
                                    <a href="<?= BASE_URL ?>abogados-art-villa-real">Villa Real</a>
