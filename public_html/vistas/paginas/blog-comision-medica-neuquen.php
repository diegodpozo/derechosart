<?php
/**
 * VISTA: COMISION MEDICA DE NEUQUEN (CM N 9) - ARTICULO DE BLOG
 */
?>
        ...
        <div class="articulo-header-wrapper">
            <header class="articulo-header">
                <nav class="breadcrumb-blog mb-20">
                    <a href="<?= BASE_URL ?>blog">Blog</a> &gt; <a href="<?= BASE_URL ?>comisiones-medicas">Comisiones Médicas</a> &gt; <span class="txt-amarillo">Neuquén</span>
                </nav>

                <span class="tag-categoria bg-amarillo mb-15">COMISIÓN MÉDICA</span>
                <h1 class="articulo-titulo">Comisión Médica de Neuquén (CM N° 9): dirección, mapa y trámite paso a paso</h1>

                <p class="articulo-lead">Si trabajás o vivís en la ciudad de Neuquén y tuviste un accidente laboral o una enfermedad profesional, el trámite ante la SRT se hace en esta Comisión Médica. Te contamos dónde queda, qué llevar y qué hacer si no estás de acuerdo con el dictamen. <span class="subrayado-amarillo">Sin palabras difíciles.</span></p>
            ...
            <div class="sidebar-sticky">
                <details class="sidebar-acordeon-movil" open>
                    ...
                    <nav class="sidebar-nav">
                        <ul>
                            <li id="preg-1"><a href="#datos-cm" class="active"><span class="nav-num">1</span> Datos y ubicación de la CM de Neuquén</a></li>
                            <li id="preg-2"><a href="#ley-27348"><span class="nav-num">2</span> Neuquén y la Ley 27.348</a></li>
                ...
                <?php
                    $titulo = "¿Tenés dudas sobre tu trámite en la CM de Neuquén?";
        ...
        <article class="articulo-cuerpo">
            ...
            <section class="articulo-contenido-texto mt-50">
                ...
                <div id="datos-cm" class="seccion-bloque">
                    <h2 class="titulo-seccion-blog"><a href="#preg-1"><span class="num-sec">1</span> Datos y ubicación de la CM de Neuquén</a></h2>
                    ...
                    <div class="custom-table-blog mt-30">
                        ...
                        <div class="tr-blog">
                            ...
                            <div>Comisión Médica N° 9</div>
                        </div>
                        <div class="tr-blog">
                            <div>Dirección</div>
                            <div>Bartolomé Mitre 590 (Q8300KWL), Neuquén Capital</div>
                        </div>
                        <div class="tr-blog">
                            <div>Jurisdicción</div>
                            <div>Primera Circunscripción Judicial de Neuquén (ciudad de Neuquén y alrededores)</div>
                        </div>
                        <div class="tr-blog">
                            <div>Delegaciones</div>
                            <div>Plaza Huincul, Zapala y Chos Malal, para las restantes circunscripciones de la provincia</div>
                        </div>
                        <div class="tr-blog">
                            <div>Horario de atención</div>
                            <div>Lunes a viernes, 7:30 a 14:30 hs</div>
                        </div>
                    </div>

                    <div class="mt-30">
                        <iframe
                            src="https://www.google.com/maps?q=Bartolome+Mitre+590,+Neuquen,+Argentina&output=embed"
                            width="100%"
                            height="340"
                        ...
                        <p class="mt-10 fs-08 txt-gris-medio flex-between" style="flex-wrap:wrap;gap:0.5rem;">
                            <span><?= render_icon('location-dot', 'mr-5') ?> Bartolomé Mitre 590, Neuquén Capital</span>
                            <a href="https://www.google.com/maps?q=Bartolome+Mitre+590,+Neuquen,+Argentina" target="_blank" rel="noopener" class="fw-700">Ver en Google Maps <?= render_icon('arrow-up', '', 'transform:rotate(45deg);') ?></a>
                        </p>
                    </div>
                ...
                <div id="ley-27348" class="seccion-bloque">
                    <h2 class="titulo-seccion-blog"><a href="#preg-2"><span class="num-sec">2</span> Neuquén y la Ley 27.348</a></h2>
                    <p>La provincia de Neuquén está adherida a la <strong>Ley 27.348</strong>, lo que significa que pasar por esta Comisión Médica es un paso obligatorio antes de poder llevar tu caso a la Justicia Laboral. Podés elegir esta jurisdicción si tu domicilio real o tu lugar de trabajo están dentro de la Primera Circunscripción Judicial (ciudad de Neuquén y zona).</p>

                    <div class="tip-blog mt-30 p-20 bg-gris border-radius-15 flex-start gap-20">
                        <div style="font-size: 2.6em;">ℹ️</div>
                        <p class="m-0 fs-09 italic">La elección de jurisdicción se hace con el <strong>formulario de opción de jurisdicción</strong> al iniciar el trámite, y <strong>no se puede cambiar</strong> después. Si trabajás en zonas como Plaza Huincul, Zapala o Chos Malal, puede corresponderte una delegación distinta a la de la capital.</p>
                    </div>
                    <a href="#que-es-guia" class="link-volver-indice mt-30"><?= render_icon('arrow-up') ?> Volver al índice</a>
                </div>
                ...
                <div id="que-llevar" class="seccion-bloque">
                    ...
                    <div class="mt-30">
                        ...
                        <div class="tip-blog p-20 bg-gris border-radius-15 flex-start gap-20 mb-15">
                            <div style="font-size: 2.6em;">📍</div>
                            <div>
                                <p class="m-0 fs-09"><strong>Opción de Jurisdicción:</strong> definí que tu trámite se haga en la CM de Neuquén según tu domicilio o lugar de trabajo.</p>
                ...
                <div id="dictamen-cm" class="seccion-bloque">
                    ...
                    <p>Después de esta Comisión Médica, si el resultado no te conforma, el camino sigue en la <strong>Justicia Laboral Ordinaria</strong> de la provincia de Neuquén, no en el fuero federal. El porcentaje de incapacidad se determina según el <a href="<?= BASE_URL ?>tabla-incapacidad" style="color:inherit;text-decoration:none;">Baremo vigente</a> (Decreto 549/2025), y el monto final de la indemnización depende de tu edad, tu sueldo y ese porcentaje: varía en cada caso.</p>
                ...
                <div id="faq-cm" class="seccion-bloque">
                    ...
                    <div class="lista-faq-blog">
                        <details class="mb-20 bg-gris p-25 border-radius-15">
                            <summary class="fw-700 pointer">¿La Comisión Médica de Neuquén atiende a toda la provincia?</summary>
                            <p class="mt-15 fs-09">La CM N° 9 de la capital atiende la Primera Circunscripción Judicial. Para Plaza Huincul, Zapala y Chos Malal hay delegaciones propias que cubren las demás circunscripciones.</p>
                        </details>
