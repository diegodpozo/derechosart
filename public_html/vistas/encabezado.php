...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>publico/css/estilos.min.css?v=3.93" media="print" onload="this.media='all'">
    <noscript>
        <link rel="stylesheet" href="<?= BASE_URL ?>publico/css/fuentes.min.css?v=3.0">
        <link rel="stylesheet" href="<?= BASE_URL ?>publico/css/estilos.min.css?v=3.93">
    </noscript>
