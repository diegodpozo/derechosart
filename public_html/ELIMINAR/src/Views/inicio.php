<div class="container">
    ...
    <!-- Formulario visible por defecto para mejorar el rendimiento (Speed Index) y evitar saltos (CLS) -->
    <form id="form-consulta" action="<?= BASE_URL ?>/api/consultas/nueva" method="POST" novalidate>
        ...
        <div id="campos_enfermedades_profesionales" style="display: none;">
            ...
            <div class="form-group">
                ...
                <input type="text" id="antiguedad_laboral" name="antiguedad_laboral" class="numeric-input" inputmode="numeric" required value="<?= htmlspecialchars($form_data['antiguedad_laboral'] ?? '') ?>">
                <span class="error-message"></span>
            </div>
            <div class="form-group">
