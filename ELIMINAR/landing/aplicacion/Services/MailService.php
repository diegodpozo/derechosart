...
// Desde copia/aplicacion/Services/ -> sube 3 niveles a copia/ -> luego 1 nivel a public_html/
...
class MailService {
    ...
    public static function enviarAvisoNuevaConsulta(array $datos_consulta) {
        ...
        try {
            ...
            $cuerpo .= "<a href='https://derechosartconsultas.com/gestion' style='color: #2c3e50; text-decoration: none; font-weight: bold;'>INGRESA AL PANEL DE GESTION PARA VER LA FICHA COMPLETA.</a>";
            $cuerpo .= "</p>";
            $cuerpo .= "<hr>";
