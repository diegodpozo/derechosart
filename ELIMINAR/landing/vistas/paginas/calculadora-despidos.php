 ...
 * LOGICA PIXEL-PERFECT BASADA EN DERECHOSART.COM Y LEY 20.744
 */
                        ...
                        <article class="info-bloque b-none bl-8-amarillo" id="resultado-final">
                                ...
                                <ul class="flex-column gap-10">
                                    <?php foreach ($DetalleRubros as $nombre => $monto): ?>
                                        ...
                                        <li class="flex-between fs-09">
                                            <span><i class="fas fa-thumbtack txt-amarillo mr-10"></i> <?php echo $nombre; ?>:</span>
                            ...
                            <article class="mt-40 p-30 border-radius-20 bg-gris">
                                ...
                                <a href="https://wa.me/5491124786144" target="_blank" class="btn btn-outline w-100">
                                   <i class="fab fa-whatsapp mr-10"></i> CONSULTANOS AHORA
                                </a>
                            </article>
                        </article>
                    <?php else: ?>
                        <article class="info-bloque b-none">
                            <h3 class="mb-20">¿Cómo se compone el total?</h3>
                            <p class="txt-gris mb-15">Nuestra calculadora desglosa todos los rubros que exige la ley:</p>
                            <ul class="flex-column gap-15 txt-gris fs-09">
                                <li><i class="fas fa-check txt-amarillo mr-10"></i> <b>Indemnización Ley 20.744:</b> El pago por tus años de servicio.</li>
                                <li><i class="fas fa-check txt-amarillo mr-10"></i> <b>Integración y Preaviso:</b> Protecciones por la falta de aviso previo.</li>
                                <li><i class="fas fa-check txt-amarillo mr-10"></i> <b>Vacaciones y SAC:</b> Los proporcionales acumulados hasta el último día.</li>
                            </ul>
                            <p class="mt-20 fs-09"><b>Dato:</b> Si tu sueldo real era mayor al que figuraba en el recibo, tu indemnización podría duplicarse.</p>
                        </article>
                    <?php endif; ?>
                </article>
