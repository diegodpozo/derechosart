    ...
    <section class="seccion-texto bg-gris">
        <section class="contenedor">
            <article class="info-bloque b-none bl-8-amarillo" style="max-width: 700px; margin: 0 auto;">
                ...
                <form id="form-consulta" action="<?= BASE_URL ?>index.php?url=api/consultas/nueva" method="POST" novalidate class="flex-column gap-15">
                    ...
                    <div id="campos_accidentes_trabajo" style="display: none;" class="bg-gris p-20 border-radius-15">
                        <h4 class="mb-15 fs-09" style="border-bottom: 1px solid #ccc; padding-bottom: 10px; text-align: center;"><span class="subrayado-amarillo"><strong>Detalles del Accidente de Trabajo</strong></span></h4>
                    ...
                    <div id="campos_despidos" style="display: none;" class="bg-gris p-20 border-radius-15">
                        <h4 class="mb-15 fs-09" style="border-bottom: 1px solid #ccc; padding-bottom: 10px; text-align: center;"><span class="subrayado-amarillo"><strong>Detalles del Despido</strong></span></h4>
                    ...
                    <div id="campos_enfermedades_profesionales" style="display: none;" class="bg-gris p-20 border-radius-15">
                        <h4 class="mb-15 fs-09" style="border-bottom: 1px solid #ccc; padding-bottom: 10px; text-align: center;"><span class="subrayado-amarillo"><strong>Detalles de la Enfermedad Profesional</strong></span></h4>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    provinciaSelect.addEventListener('change', function() {
        ...
        if (provId) {
            ...
            const url = `${protocol}//${host}${baseUrl}index.php?url=api/localidades&provincia_id=${provId}`;
