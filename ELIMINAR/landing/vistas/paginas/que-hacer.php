 ...
 * CONTENIDO EXTRAIDO DE DERECHOSART.COM
 */
?>
        ...
        <section class="contenedor">
            ...
            <article class="info-bloque b-none bl-8-amarillo mb-40">
                ...
                <ul class="flex-column gap-15 txt-gris fs-09">
                    <li><i class="fas fa-check txt-amarillo mr-10"></i> <b>Formas de denunciar:</b> Por teléfono, mail o enviando un telegrama gratuito por Correo Argentino.</li>
                    <li><i class="fas fa-check txt-amarillo mr-10"></i> <b>Aceptación:</b> La ART debe brindarte atención médica en un plazo máximo de 72 horas hábiles.</li>
                    <li><i class="fas fa-check txt-amarillo mr-10"></i> <b>Rechazo:</b> La ART tiene 10 días hábiles (prorrogables) para notificarte si rechaza el accidente.</li>
                </ul>
            </article>
            ...
            <article class="info-bloque b-none bl-8-amarillo mb-40">
                ...
                <section class="grid-info-doble mt-20 gap-30">
                    <article class="bg-gris p-20 border-radius-20">
                        <h4 class="mb-10">Si estás recuperado</h4>
                    ...
                    <article class="bg-gris p-20 border-radius-20">
                        <h4 class="mb-10">Si seguís con dolores</h4>
            ...
            <article class="info-bloque b-none bl-8-amarillo">
                ...
                <ul class="flex-column gap-15 txt-gris fs-09">
                    <li><i class="fas fa-check txt-amarillo mr-10"></i> <b>Factores del cálculo:</b> Se basa en tu porcentaje de incapacidad, edad, sueldo y lugar del hecho.</li>
                    <li><i class="fas fa-check txt-amarillo mr-10"></i> <b>Revisión Médica:</b> Es fundamental ir a la junta médica con un <strong>médico de parte</strong> para asegurar que el porcentaje de incapacidad sea el real.</li>
                    <li><i class="fas fa-check txt-amarillo mr-10"></i> <b>Plazos:</b> Si pasaron 31 días desde el alta y la ART no te citó, iniciamos nosotros el trámite.</li>
                </ul>
            </article>
        ...
        <section class="contenedor">
            ...
            <section class="grid-info-doble mt-30">
                <article class="info-bloque">
                    <h3 class="txt-amarillo"><i class="fas fa-exclamation-triangle mr-10"></i> NO CONFÍES</h3>
                ...
                <article class="info-bloque">
                    <h3 class="txt-amarillo"><i class="fas fa-user-md mr-10"></i> MÉDICO DE PARTE</h3>
    ...
    <section class="py-60 bg-gris centro">
        <section class="contenedor">
            ...
            <a href="https://wa.me/5491124786144" target="_blank" class="btn btn-amarillo">
                <i class="fab fa-whatsapp mr-10"></i> CONSULTANOS GRATIS POR WHATSAPP
            </a>
        </section>
    </section>
</main>
