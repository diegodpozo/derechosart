 ...
 * CONTENIDO AMPLIADO SEGÚN DERECHOSART.COM
 */
?>
            ...
            <section class="grid-info-doble mt-0 al-inicio">
                <article class="info-bloque b-none bl-8-amarillo">
                    ...
                    <ul class="flex-column gap-15 txt-gris fs-09 mb-30">
                        <li><i class="fas fa-check txt-amarillo mr-10"></i> Necesitás tu número de <b>CUIL</b> (sin puntos ni guiones).</li>
                        <li><i class="fas fa-check txt-amarillo mr-10"></i> No se puede consultar solo con el número de DNI.</li>
                        <li><i class="fas fa-check txt-amarillo mr-10"></i> También podés consultar con el <b>CUIT del empleador</b>.</li>
                    </ul>
                    <a href="https://www.srt.gob.ar/index.php/consulta-de-art-trabajadores/" target="_blank" class="btn btn-amarillo">
            ...
            <article class="info-bloque b-none" style="overflow-x: auto; padding: 0;">
                <table class="w-100" style="border-collapse: collapse; min-width: 600px;">
                    ...
                    <tbody class="fs-09">
                        ...
                        <tr><td><b>Galeno</b></td><td>0800-333-1400</td><td>0800-333-0808</td></tr>
                        <tr style="background-color: var(--gris-claro);"><td><b>Swiss Medical</b></td><td>0800-666-2000</td><td>0800-222-7854</td></tr>
                        <tr><td><b>Asociart</b></td><td>0800-888-0095</td><td>0800-888-0093</td></tr>
                        <tr style="background-color: var(--gris-claro);"><td><b>Omint</b></td><td>0800-888-6060</td><td>0800-555-0278</td></tr>
        ...
        <section class="contenedor">
            ...
            <section class="grid-iconos mt-40">
                <article class="icono-item bg-blanco p-30 border-radius-20">
                    <i class="fas fa-ambulance fs-25 txt-amarillo mb-20"></i>
                ...
                <article class="icono-item bg-blanco p-30 border-radius-20">
                    <i class="fas fa-pills fs-25 txt-amarillo mb-20"></i>
                ...
                <article class="icono-item bg-blanco p-30 border-radius-20">
                    <i class="fas fa-shield-alt fs-25 txt-amarillo mb-20"></i>
    ...
    <section class="py-60 bg-blanco centro">
        <section class="contenedor">
            ...
            <a href="https://wa.me/5491124786144" target="_blank" class="btn btn-amarillo">
                <i class="fab fa-whatsapp mr-10"></i> CONSULTANOS POR WHATSAPP
            </a>
        </section>
    </section>
</main>
...
<style>
    /* ESTILOS ESPECIFICOS PARA LA TABLA SIN REPETIR EN CSS GLOBAL */
    table tbody tr td {
        padding: 12px 15px;
