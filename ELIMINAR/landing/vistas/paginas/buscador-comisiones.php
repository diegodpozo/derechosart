...
<main class="fade-in">
                ...
                <section class="grid-info-doble mt-50">
                    <article class="info-bloque">
                        ...
                        <ul class="lista-simple">
                            <li><i class="fas fa-map-marker-alt txt-dorado"></i> Dirección exacta y número de sede.</li>
                            <li><i class="fas fa-clock txt-dorado"></i> Horarios de atención al público.</li>
                            <li><i class="fas fa-balance-scale txt-dorado"></i> Competencia territorial (qué zonas cubre).</li>
                        </ul>
                    </article>
                    <article class="info-bloque">
    ...
    <section class="seccion-cta bg-gris" style="padding: 60px 0;">
        <section class="contenedor centro">
            ...
            <a href="?url=contacto" class="btn btn-amarillo">
                CONTACTO
            </a>
        </section>
    </section>
